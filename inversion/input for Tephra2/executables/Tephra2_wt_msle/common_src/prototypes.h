...
/* 2 lines added by Laura (Oct, 2014) */
double get_grain(FILE *in);
double get_rho(double part_size_slice, GRAIN *);
...
void set_eruption_values(ERUPTION *, WIND *, GRAIN *);
int get_points(FILE *);
...
double mse(FILE *, int, POINT *);
double mape(FILE *, int, POINT *);
double mae(FILE *, int, POINT *);
double msle(FILE *, int, POINT *);
...
double pdf_grainsize(double, double, double, GRAIN *);
...
void tephra_calc(ERUPTION *, POINT *, WIND *, STATS *, GRAIN *);
